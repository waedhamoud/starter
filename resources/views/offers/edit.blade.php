           ...
           <div class="content">
            ...
            <form method="POST" action="{{ route('offers.update',$offer -> id) }}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="name" value="{{ $offer -> name }}" aria-describedby="emailHelp" placeholder="Enter The name">
                  @error('name')
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" name="price" value="{{ $offer -> price }}" placeholder="price">
                @error('price')
                <small class="form-text text-danger">{{ $message }}</small>
